...
import ir.magiccodes.wikipedia.SecondActivity
import ir.magiccodes.wikipedia.adapter.ItemEvents
import ir.magiccodes.wikipedia.adapter.TrendAdapter
import ir.magiccodes.wikipedia.data.ItemPost
import ir.magiccodes.wikipedia.databinding.FragmentTerndBinding

const val KEY_SEND_DATA_TO_SECOND_ACTIVITY = "sendData"

class FragmentTrend : Fragment() , ItemEvents {
    lateinit var binding: FragmentTerndBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentTerndBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onItemClicked(itemPost: ItemPost) {
        ...
        intent.putExtra(KEY_SEND_DATA_TO_SECOND_ACTIVITY , itemPost)
